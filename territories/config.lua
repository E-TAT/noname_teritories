...
Config = {
  ...
  GangJobs = {                        -- List all jobs that are able to contest for and control territories here.
    "max", 
    "sha",                         -- NOTE: Don't need to include police. Thats taken from PoliceJob var above.
    "mc",
    "bsb",
    "trd",
    "chm"
...
DrugPrices = {
  ['weed_packaged'] = 360, --------evide change cheythatt karyam illa esx_drugs yil change cheyanam [JMC]
  ['cocaine_packaged'] = 385,
  ['meth_packaged'] = 390,
}
...
MarkerColors = {
  police  = { r = 125, g = 249, b = 255, a = 100 },
  max   = { r = 255, g = 0, b = 0, a = 100 },
  sha   = { r = 255, g = 255, b = 255, a = 100 },
  mc  = { r = 0, g = 255, b = 60, a = 100 },
  bsb   = { r = 128, g = 0, b = 128, a = 100 },
  trd   = { r = 255, g = 119, b = 0, a = 100 },
  chm  = { r = 0, g = 0, b = 0, a = 100 },
}
...
Territories = {
  ["East V"] = {
    ...
    zone = "EAST_V",  
    loc = vector3(904.06,-164.28,40.01),    --don't change z value '0.01' (change only x,y)  
                                -- Probably don't change this unless you intend on moving the zones around.
    ...
    actions = { 
      ...
      ["gather_money"] = {
        ...
        requireCash = 20000,                              -- If not requireItem, requireCash instead. NOTE: Always dirty.

        rewardRate  = 20,                                 -- Reward item from perform action.
  ...
  ["Davis"] = {
    ...
    influence = 100.0,
    zone      = "DAVIS",
    loc = vector3(108.96, -1798.0, 1.01),        --don't change z value '0.01' (change only x,y)  
    ...
    areas = {
      [1] = {
        location  = vector3(108.96, -1798.0, 27.08),
        width     = 150.0,
        height    = 150.0,
        heading   = 50,
        display   = 10
    ...
    blipData = {
      pos = vector3(108.96, -1798.0, 27.08),
      sprite = 496,
      color = 2,
  ...
  ["ChamberlainHills"] = {
    ...
    influence = 100.0,
    zone      = "CHAMH",
    loc = vector3(-212.84, -1618.12, 1.00),             --don't change z value '0.01' (change only x,y)  
    ...
    areas = {
      [1] = {
        location  = vector3(-212.84, -1618.12, 34.88),
        width     = 150.0,
        height    = 150.0,
        heading   = 50,
        display   = 10
    ...
    blipData = {
      pos = vector3(-212.84, -1618.12, 34.88),
      sprite = 499,
      color = 3,
  ...
  ["Rancho"] = {
    ...
    influence = 100.0,
    zone      = "RANCHO",
    loc = vector3(465.00, -1894.07, 0.01),   --don't change z value '0.01' (change only x,y)  
    ...
    blipData = {
      pos = vector3(465.00, -1894.07, 25.90),
      sprite = 497,
      color = 0,
